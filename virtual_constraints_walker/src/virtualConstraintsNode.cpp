...
//     core(0);
    ...
    _com_max(_initial_param.get_max_steps());
...
//     {
//         for (j = alpha * length_step; j <= length_step; j = j+dx)
//         {
//             spatial_window_preview[j] = current_spatial_zmp_y * _switched;
//         }
//         alpha = 0;
//         _switched = - _switched;
//     }
