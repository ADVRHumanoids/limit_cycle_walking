...
% (to run this script you need a dynamic model of the robot, which can be
% created by using %model_n

if ~exist('model_n_created','var')
model_n;
end
...
q1_Ddot_ZeroDyn =  (kappa_Z(1) * kappa_Z(2));
...
q1_Ddot_ZeroDyn1 = simplify(-(g1 + c11*q1_dot + c12*q2_dot)/d11);
