function [D,C,G,E2,T] = replaceMatricesExtended(symD, symC, symG, symE2, symT)
%=========================================
...
newStr = strrep(newStr,'z1(t)','q(3)');
newStr = strrep(newStr,'z2(t)','q(4)');
...
newStr = strrep(newStr,'z1(t)','q(3)');
newStr = strrep(newStr,'z2(t)','q(4)');
newStr = strrep(newStr,'z1_dot(t)','q_dot(3)');
newStr = strrep(newStr,'z2_dot(t)','q_dot(4)');
